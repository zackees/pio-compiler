            ...
            if example_path.is_dir():
                ...
                if self.platform.name == "native":
                    ...
                    if ino_files:
                        ...
                        stubs_path = src_dir / "_arduino_runtime_stubs.cpp"
                        ...
                        if not wrapper_path.exists():
                            wrapper_content = (
                                ...
                                "// plain Arduino *.ino* sketch.  The FastLED stub provides the runtime\n"
                                "// (`main`, `setup`, `loop`, delay, …) when the following build flags\n"
                                "// are present:\n"
                                "//   -DFASTLED_STUB_IMPL\n"
                                '//   -DFASTLED_STUB_MAIN_INCLUDE_INO="{sketch.name}"\n\n'
                                "#include <chrono>\n"
                                "#include <thread>\n\n"
                        ...
                        # --------------------------------------------------
                        # Generate separate *Arduino runtime* stubs once.
                        # --------------------------------------------------
                        if not stubs_path.exists():
                            stubs_code = (
                                "// Auto-generated Arduino runtime stubs for host compilation.\n\n"
                                "#include <chrono>\n"
                                "#include <thread>\n"
                                "#include <cstdint>\n\n"
